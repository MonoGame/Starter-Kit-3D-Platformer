...
public class Player : AnimatedEntity
{
    ...
    override protected void LoadContent()
    {
        ...
        base.LoadContent();
        _jumpSound = Content.Load<SoundEffect>(Path.Combine("Sounds", "jump"));
        _landSound = Content.Load<SoundEffect>(Path.Combine("Sounds", "land")).CreateInstance();
        _walkSound = Content.Load<SoundEffect>(Path.Combine("Sounds", "walking")).CreateInstance();
        _playerDied = Content.Load<SoundEffect>(Path.Combine("Sounds", "burst")).CreateInstance();
    }
